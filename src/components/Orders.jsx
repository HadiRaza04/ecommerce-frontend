...
const Orders = () => {
    ...
    if (loading) return <div className="text-center mt-20 text-xl font-semibold">Loading your orders...</div>;

    return (
        <div className="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
                <h1 className="text-3xl font-bold text-gray-900 mb-8 border-b pb-4">
                    My Orders ({favorites.length})
                </h1>

                {favorites.length === 0 ? (
                    <div className="text-center py-20 bg-white rounded-lg shadow">
                        <p className="text-gray-500 text-lg">You haven't added any orders yet.</p>
